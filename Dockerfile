...
FROM golang:1.26.2@sha256:b54cbf583d390341599d7bcbc062425c081105cc5ef6d170ced98ef9d047c716 AS jni-builder
ARG BUILDARCH=amd64
COPY --from=gradle:9.5.0-jdk21-noble@sha256:f2796e317ff13e2d0e10b83bb4aed71721d51570b55829972a5d9d89a6e96381 /opt/java/openjdk/include /opt/java/include
WORKDIR /build
...
FROM gradle:9.5.0-jdk21-noble@sha256:f2796e317ff13e2d0e10b83bb4aed71721d51570b55829972a5d9d89a6e96381 AS javaagent-builder
